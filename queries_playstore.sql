...
INSERT INTO products (name, price, can_be_returned) VALUES ('hat', '5.00', 't');
...
--id, app_name, category, rating, reviews, size, min_installs, price, content_rating, genres, last_updated, current_version, android version--
...
SELECT * FROM analytics WHERE min_installs <= 50 rating IS NOT NULL ORDER BY rating DESC;
